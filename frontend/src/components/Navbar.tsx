export default function Navbar() {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex justify-between items-center px-8 md:px-14 py-4 bg-[#faf7f2]/80 backdrop-blur-xl border-b border-orange-100">
      ...
      <button className="px-6 py-2.5 rounded-xl text-sm font-semibold bg-orange-500 hover:bg-orange-600 text-white transition-all duration-200 shadow-md shadow-orange-200">
        Get Started
      </button>
    </nav>
  );
