    ...
    <section id="features" className="px-8 md:px-14 py-24 bg-white">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <p className="text-xs tracking-[0.3em] uppercase text-orange-500 font-semibold mb-3">Why Estate Vision</p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {features.map((f, i) => (
            ...
            >
              <div className={`inline-flex w-12 h-12 items-center justify-center rounded-2xl ${f.iconBg} text-2xl mb-6`}>
                {f.icon}
              </div>
              <h3 className="text-lg font-bold text-stone-900 mb-3" style={{ fontFamily: "Syne, sans-serif" }}>{f.title}</h3>
